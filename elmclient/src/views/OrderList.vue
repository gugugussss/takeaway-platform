<template>
  <div class="wrapper">
    ...
    <!-- 订单列表部分 -->
    <h3 style="font-weight: bold;color:red;">未支付订单信息：</h3>
    <ul class="order">
        ...
        <template v-if="item.orderState === 0">
          ...
          <div class="order-info">
            ...
            <div class="order-info-right">
              <p>&#165;{{ item.orderTotal }}</p>
              <div class="order-info-right-icon" @click="detailetPayment(item.orderId)">{{Statement}}</div>
            </div>
          </div>
    ...
    <h3 style="font-weight: bold; color:red;" >已支付订单信息：</h3>
    <ul class="order">
      <li v-for="item in orderArr" :key="item">
