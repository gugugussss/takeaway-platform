		...
		<ul class="form-box">
			<li>
				...
				<div class="content">
					...
					<input type="text" v-model="userId" placeholder="手机号码" :disabled="isLoggingIn"
						pattern="^1[3456789][0-9]{9}$" maxlength="11">
				</div>
			</li>
			<li>
				<div class="title">
				...
				<div class="content">
					...
					<input type="password" v-model="password" placeholder="密码" :disabled="isLoggingIn"
						pattern="[A-Za-z0-9]{6,}" title="密码需包含且只能包含大、小写字母和数字，长度至少为6位">
				</div>
			</li>
		</ul>
