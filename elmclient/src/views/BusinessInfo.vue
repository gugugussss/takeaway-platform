<template>
	<div class="wrapper">
		<!-- header部分 -->
		<header>
      <div @click="toBusinessList"><i class="fa fa-angle-left" /></div>
			<p>商家信息</p>
		</header>
		<!-- 商家logo部分 -->`
...
<!--		</div>-->
		...
		<!-- 食品列表部分 -->
		<ul class="food">
			<li v-for="(item,index) in foodArr" :key="item">
				<div class="food-left">
...
<style scoped>
  ...
  .wrapper header div{
	...
	/*不够起送费时的样式（只有背景色和鼠标样式的区别），两区别通过行内样式体现，故该样式无需出现*/
	/*
 .wrapper .cart .cart-right .cart-right-item{
 width: 100%;
 height: 100%;
